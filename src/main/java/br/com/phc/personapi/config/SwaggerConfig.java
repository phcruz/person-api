package br.com.phc.personapi.config;
...
public class SwaggerConfig {
	...
	private static final String BASE_PACKAGE = "br.com.phc.personapi.controller";
	private static final String API_TITLE = "Person API";
	private static final String API_DESCRIPTION = "REST API for person";
